...
/**
 * @ORM\Entity(repositoryClass="BackendBundle\Entity\Repository\DairyRepository")
 * @ORM\Table(name="dairy_table")
 * @Vich\Uploadable
 */
class Dairy
{
     ...
     * @ORM\OneToMany(targetEntity="BackendBundle\Entity\ProductContentBlock", mappedBy="dairy", cascade={"persist"})
     */
