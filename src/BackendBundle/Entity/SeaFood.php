...
/**
 * @ORM\Entity(repositoryClass="BackendBundle\Entity\Repository\SeaFoodRepository")
 * @ORM\Table(name="seafood_table")
 * @Vich\Uploadable
 */
class SeaFood
{
     ...
     * @ORM\OneToMany(targetEntity="BackendBundle\Entity\ProductContentBlock", mappedBy="seafood", cascade={"persist"})
     */
