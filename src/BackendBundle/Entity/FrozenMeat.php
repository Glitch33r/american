...
/**
 * @ORM\Entity(repositoryClass="BackendBundle\Entity\Repository\FrozenMeatRepository")
 * @ORM\Table(name="frozen_meat_table")
 * @Vich\Uploadable
 */
class FrozenMeat
{
     ...
     * @ORM\OneToMany(targetEntity="BackendBundle\Entity\ProductContentBlock", mappedBy="meat", cascade={"persist"})
     */
