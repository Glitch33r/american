        ...
        return (
            <section className="content-wrap">
                ...
                <section className="team-block">
                        ...
                        <React.Fragment>
                            ...
                            <div className="team-block__right team-block__right--w500">
                                <div className="team-block__right_img"
                                     style={{background: 'url(/uploads/images/first-blc-off/' + item.image + ') center center no-repeat', backgroundSize: 'contain'}}/>
                            </div>
                        </React.Fragment>
                    ) }
                    ...
                    {/*<div className="team-block__right team-block__right--w500">*/}
                        {/*<div className="team-block__right_img"*/}
                             {/*style={{background: 'url(/uploads/images/first-blc-off/) center center no-repeat', backgroundSize: 'contain'}}/>*/}
                    {/*</div>*/}
